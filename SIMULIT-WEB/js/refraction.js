...
function setup() {
  ...
  mirror = new Mirror(mouseX, mouseY, 200, 60);
...
class Beam {
  ...
  touch(mirror) {
    ...
    if (refracted) {
      refracted.normalize();
      stroke(120, 80, 100); // green refracted ray
      line(pt.x, pt.y, pt.x + refracted.x * 4000, pt.y + refracted.y * 4000);
    } else {
...
function refract(I, N, n1, n2) {
  ...
  if (k < 0) {
    ...
    return p5.Vector.add(
      ...
      p5.Vector.mult(N, eta * cosi - sqrt(k))
    );
  }
}
